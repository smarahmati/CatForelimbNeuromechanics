...
% muscle parameters for the equivalent muscle in group 6, i.e., Wrist Dorsiflexors
...
% [Mean_MMT_Elbow] = Muscle_Moment_G6(x);
...
pro = pro_SetModel(pro, @(x)Muscle_Moment_G6(x), 'model');
...
% algorithm
Sfast_G6 = GSA_FAST_GetSi(pro);



save('Sfast_G6.mat','Sfast_G6');
