...
% muscle parameters for the equivalent muscle in group 8, i.e., Shoulder Retractors
...
% [Mean_MMT_Elbow] = Muscle_Moment_G8(x);
...
pro = pro_SetModel(pro, @(x)Muscle_Moment_G8(x), 'model');
...
% algorithm
Sfast_G8 = GSA_FAST_GetSi(pro);



save('Sfast_G8.mat','Sfast_G8');

%% plot
bar(Sfast_G8)
% a1,a2,phi1,phi2,R1,LF0,Vmax_LF0,SO,PCSA,PA
set(gca,'xticklabel',{'a1','a2','phi1','phi2','R1','LF0','Vmax/LF0','SO','PCSA','PA'})
