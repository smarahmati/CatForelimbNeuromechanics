...
% muscle parameters for the equivalent muscle in group 4, i.e., Elbow Flexors
...
% [Mean_MMT_Elbow] = Muscle_Moment_G4(x);
...
pro = pro_SetModel(pro, @(x)Muscle_Moment_G4(x), 'model');
...
% algorithm
Sfast_G4 = GSA_FAST_GetSi(pro);


save('Sfast_G4.mat','Sfast_G4');
