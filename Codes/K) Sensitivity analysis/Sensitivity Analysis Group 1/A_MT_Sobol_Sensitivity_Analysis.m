...
% muscle parameters for the equivalent muscle in group 1, i.e., Shoulder Protractors
...
% [Mean_MMT_Shoulder] = Muscle_Moment_G1(x);
...
pro = pro_SetModel(pro, @(x)Muscle_Moment_G1(x), 'model');
...
% algorithm
  Sfast_G1 = GSA_FAST_GetSi(pro);



save('Sfast_G1.mat','Sfast_G1');
