...
function [MMT_Shoulder, MMT_Elbow, MMT_Wrist, MMT, Force_MT ] = Results_Function (xopt)
...
%
% xopt is activation for 40 muscles
...
LT0 = 0.5*LF0;                      % we do not need its value for now
...
% Muscle fatigue
  Muscle_Fatigue(mn,1) = (FMT/PCSA)^3; %(1)
