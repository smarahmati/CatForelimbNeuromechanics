...
%% Write information
cmn = 33;                                              % considered muscle number
mn = 'Spinodeltoideus';                                % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_Spinodeltoideus.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_Spinodeltoideus.fig')
