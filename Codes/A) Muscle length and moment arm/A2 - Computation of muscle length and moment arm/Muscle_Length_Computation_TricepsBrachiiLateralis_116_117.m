...
%% Write information
cmn = 37;                                              % considered muscle number
mn = 'Triceps Brachii Lateralis';                      % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_TricepsBrachiiLateralis.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_TricepsBrachiiLateralis.fig')
...
txt_title = 'Triceps Brachii Lateralis';
title(txt_title)
