...
%% Write information
cmn = 15;                                                       % considered muscle number
mn = 'Flexor Carpi Radialis';                                   % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorCarpiRadialis.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorCarpiRadialis.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorCarpiRadialis.fig')
...
txt_title = 'Flexor Carpi Radialis';
title(txt_title)
