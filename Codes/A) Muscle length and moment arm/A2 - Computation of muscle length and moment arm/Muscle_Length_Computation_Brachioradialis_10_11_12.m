...
% Brachioradialis(11->12)  --------------------------------------------------------------------
MN = 7;
alpha1WI = ELBa;
alpha1WI_dot = ELBa_dot;
y1WI = q2;
y2WI = q3;
XC1WI = ELB(:,1);
YC1WI = ELB(:,2);
...
%% Write information
cmn = 4;                                                        % considered muscle number
mn = 'Brachioradialis';                                         % muscle name
...
ma = [MuscleMomentArmOW_time, MuscleMomentArmWI_time, time*0];  % muscle momemet arm
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_Brachioradialis.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_Brachioradialis.fig')
...
% set(gca,'XTick',[])
savefig('MuscleMomentArm_Brachioradialis.fig')
