...
%% Write information
cmn = 39;                                              % considered muscle number
mn = 'Triceps Brachii Medial';                         % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_TricepsBrachiiMedial.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_TricepsBrachiiMedial.fig')
...
txt_title = 'Triceps Brachii Medial';
title(txt_title)
