...
% set(gca,'XTick',[])
savefig('MuscleLength_Acromiodeltoideus.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_Acromiodeltoideus.fig')


figure(3)
plot(time, MuscleMomentArm_time,'-k','LineWidth',1)
hold on
...
% set(gca,'XTick',[])
savefig('MuscleMomentArm_Acromiodeltoideus.fig')
