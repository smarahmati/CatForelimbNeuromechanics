...
% Flexor Digitorum Profundus 4(70->71) --------------------------------------------------------------------
MN = 45;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Flexor Digitorum Profundus 4(71->72)  --------------------------------------------------------------------
MN = 46;
alpha1WI = WRTa;
...
%% Write information
cmn = 20;                                                       % considered muscle number
mn = 'Flexor Digitorum Profundus 4';                            % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorDigitorumProfundus4.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorDigitorumProfundus4.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorDigitorumProfundus4.fig')
...
txt_title = 'Flexor Digitorum Profundus 4';
title(txt_title)
