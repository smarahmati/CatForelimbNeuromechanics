...
%% Write information
cmn = 27;                                                       % considered muscle number
mn = 'Palmaris Longus 1';                                       % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_PalmarisLongus1.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_PalmarisLongus1.fig')
