...
% Extensor Digitorum Communis 2(23->24) --------------------------------------------------------------------
MN = 14;
alpha1OW = ELBa;
...
% Extensor Digitorum Communis 2(24->25)  --------------------------------------------------------------------
MN = 15;
alpha1WI = WRTa;
...
%% Write information
cmn = 8;                                                        % considered muscle number
mn = 'Extensor Digitorum Communis 2';                           % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_ExtensorDigitorumCommunis2.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_ExtensorDigitorumCommunis2.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_ExtensorDigitorumCommunis2.fig')
...
title('Total Muscle Length (m)')
% set(gca,'XTick',[])

subplot(3,1,2)
plot(time, WRTa,'-k','LineWidth',1)
grid on
xlabel('Time(s)');
ylabel('Joint Angle (rad)');
title('Left wrist angle (rad)')
% set(gca,'XTick',[])
...
txt_title = 'Extensor Digitorum Communis 2';
title(txt_title)
