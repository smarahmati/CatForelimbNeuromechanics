...
% Flexor Digitorum Profundus 3(67->68) --------------------------------------------------------------------
MN = 43;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Flexor Digitorum Profundus 3(68->69)  --------------------------------------------------------------------
MN = 44;
alpha1WI = WRTa;
...
%% Write information
cmn = 19;                                                       % considered muscle number
mn = 'Flexor Digitorum Profundus 3';                            % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorDigitorumProfundus3.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorDigitorumProfundus3.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorDigitorumProfundus3.fig')
...
txt_title = 'Flexor Digitorum Profundus 3';
title(txt_title)
