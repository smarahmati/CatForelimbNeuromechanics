...
%% Write information
cmn = 5;                                               % considered muscle number
mn = 'Brachialis';                                     % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_Brachialis.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_Brachialis.fig')
...
% set(gca,'XTick',[])
savefig('MuscleMomentArm_Brachialis.fig')
