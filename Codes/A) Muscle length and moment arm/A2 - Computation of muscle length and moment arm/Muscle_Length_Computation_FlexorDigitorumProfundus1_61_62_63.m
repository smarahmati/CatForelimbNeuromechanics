...
% Flexor Digitorum Profundus 1(61->62) --------------------------------------------------------------------
MN = 39;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Flexor Digitorum Profundus 1(62->63)  --------------------------------------------------------------------
MN = 40;
alpha1WI = WRTa;
...
%% Write information
cmn = 17;                                                       % considered muscle number
mn = 'Flexor Digitorum Profundus 1';                            % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorDigitorumProfundus1.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorDigitorumProfundus1.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorDigitorumProfundus1.fig')
...
txt_title = 'Flexor Digitorum Profundus 1';
title(txt_title)
