...
% Extensor Pollicis Longus 1 (47->48) --------------------------------------------------------------------
MN = 30;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Extensor Pollicis Longus 1 (48->49)  --------------------------------------------------------------------
MN = 31;
alpha1WI = WRTa;
...
%% Write information
cmn = 12;                                                       % considered muscle number
mn = 'Extensor Pollicis Longus 1';                              % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_ExtensorPollicisLongus1.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_ExtensorPollicisLongus1.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_ExtensorPollicisLongus1.fig')
...
txt_title = 'Extensor Pollicis Longus 1 ';
title(txt_title)
