...
%% Write information
cmn = 26;                                                       % considered muscle number
mn = 'Infraspinatus';                                           % muscle name
...
ma = [MuscleMomentArmWI_time, time*0, time*0];                  % muscle momemet arm
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_Infraspinatus.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_Infraspinatus.fig')
