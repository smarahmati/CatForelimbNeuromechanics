...
% Flexor Digitorum Profundus 2(64->65) --------------------------------------------------------------------
MN = 41;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Flexor Digitorum Profundus 2(65->66)  --------------------------------------------------------------------
MN = 42;
alpha1WI = WRTa;
...
%% Write information
cmn = 18;                                                       % considered muscle number
mn = 'Flexor Digitorum Profundus 2';                            % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorDigitorumProfundus2.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorDigitorumProfundus2.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorDigitorumProfundus2.fig')
...
txt_title = 'Flexor Digitorum Profundus 2';
title(txt_title)
