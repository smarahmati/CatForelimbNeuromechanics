...
%% Write information
cmn = 40;                                       % considered muscle number
mn = 'Teres Minor';                             % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_TeresMinor.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_TeresMinor.fig')
