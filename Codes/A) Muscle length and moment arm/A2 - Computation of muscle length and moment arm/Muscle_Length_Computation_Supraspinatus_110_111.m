...
%% Write information
cmn = 34;                                              % considered muscle number
mn = 'Supraspinatus';                                  % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_Supraspinatus.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_Supraspinatus.fig')
