...
% Extensor Digitorum Communis 3(26->27) --------------------------------------------------------------------
MN = 16;
alpha1OW = ELBa;
...
% Extensor Digitorum Communis 3(27->28)  --------------------------------------------------------------------
MN = 17;
alpha1WI = WRTa;
...
%% Write information
cmn = 9;                                                        % considered muscle number
mn = 'Extensor Digitorum Communis 3';                           % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_ExtensorDigitorumCommunis3.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_ExtensorDigitorumCommunis3.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_ExtensorDigitorumCommunis3.fig')
...
txt_title = 'Extensor Digitorum Communis 3';
title(txt_title)
