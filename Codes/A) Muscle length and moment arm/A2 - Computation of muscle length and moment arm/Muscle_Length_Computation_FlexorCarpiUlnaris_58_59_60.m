...
%% Write information
cmn = 16;                                                       % considered muscle number
mn = 'Flexor Carpi Ulnaris';                                    % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorCarpiUlnaris.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorCarpiUlnaris.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorCarpiUlnaris.fig')
...
txt_title = 'Flexor Carpi Ulnaris';
title(txt_title)
