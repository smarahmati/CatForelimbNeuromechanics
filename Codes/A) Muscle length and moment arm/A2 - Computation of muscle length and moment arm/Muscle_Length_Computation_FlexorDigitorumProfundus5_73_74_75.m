...
% Flexor Digitorum Profundus 5(70->71) --------------------------------------------------------------------
MN = 47;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Flexor Digitorum Profundus 5(71->72)  --------------------------------------------------------------------
MN = 48;
alpha1WI = WRTa;
...
%% Write information
cmn = 21;                                                       % considered muscle number
mn = 'Flexor Digitorum Profundus 5';                            % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_FlexorDigitorumProfundus5.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_FlexorDigitorumProfundus5.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_FlexorDigitorumProfundus5.fig')
...
txt_title = 'Flexor Digitorum Profundus 5';
title(txt_title)
