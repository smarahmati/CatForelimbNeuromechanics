...
%% Write information
cmn = 6;                                               % considered muscle number
mn = 'Coracobrachialis';                              % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_Coracobrachialis.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_Coracobrachialis.fig')
...
% set(gca,'XTick',[])
savefig('MuscleMomentArm_Coracobrachialis.fig')
