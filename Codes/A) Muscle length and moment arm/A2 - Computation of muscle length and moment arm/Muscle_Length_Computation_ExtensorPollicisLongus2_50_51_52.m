...
% Extensor Pollicis Longus 2 (50->51) --------------------------------------------------------------------
MN = 32;
y1OW = q3;
XC1OW = ELB(:,1);
YC1OW = ELB(:,2);
...
% Extensor Pollicis Longus 2 (51->52)  --------------------------------------------------------------------
MN = 33;
alpha1WI = WRTa;
...
%% Write information
cmn = 13;                                                       % considered muscle number
mn = 'Extensor Pollicis Longus 2';                              % muscle name
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleLength_ExtensorPollicisLongus2.fig')
...
% title('Comparision of muscle length based on joint angle and segment orientation')
% set(gca,'XTick',[])
savefig('MuscleVelocity_ExtensorPollicisLongus2.fig')
...
title('Muscle Moment Arm based on joint angle')
% set(gca,'XTick',[])
savefig('MuscleMomentArm_ExtensorPollicisLongus2.fig')
...
txt_title = 'Extensor Pollicis Longus 2 ';
title(txt_title)
