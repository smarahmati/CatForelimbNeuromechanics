...
%% Write information
cmn = 32;                                              % considered muscle number
mn = 'Pronator Teres';                                 % muscle name
...
% set(gca,'XTick',[])
savefig('MuscleLength_PronatorTeres.fig')
...
% set(gca,'XTick',[])
savefig('MuscleVelocity_PronatorTeres.fig')
