...
%-------------- 1 ------------------------------------
% x0 = [0.00374132947550536,0.0959423110443161,1.25487583485539,-0.0641175415498308,0.0308432926131268,-0.240074350195126,0.00439443777673929]
...
%-------------- 2 ------------------------------------
% x0 = [0.00470242418732448,0.0967946025812123,1.93375891080800,-0.0570280399641253,0.0315867809751001,-0.210576959668887,0.00501098910130250]
% xopt = [0.00639950093128890,0.0962782352370070,-0.0513692595918855,-0.0516287259095689,0.0301982717391937,-0.158577935141393,0.00271047162543494]
% PE = 5.0833
% CF = 1.5605

%-------------- 3 ------------------------------------
% x0 = [0.00457201942106136,0.0966789606186771,1.84164562816177,-0.0579899688831348,0.0314859018162927,-0.214579271064051,0.00492733321351106]
% xopt = [0.00639059368655760,0.0962786615402975,-0.0560509789968721,-0.0516251100486373,0.0299059343315161,-0.160302711780320,0.00271046376521529]
% PE = 5.0845
% CF = 1.5608
...
% Lmt   
  line([XO_time(ii,1) XW_time(ii,1)],[YO_time(ii,1) YW_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on   
...
% Lmt1    
  line([XW_time(ii,1) XP1WI_time(ii,1)],[YW_time(ii,1) YP1WI_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on
...
% Lmt3   
  line([XP2WI_time(ii,1) XI_time(ii,1)],[YP2WI_time(ii,1) YI_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on  
  
  
else
% Lmt   
  line([XW_time(ii,1) XI_time(ii,1)],[YW_time(ii,1) YI_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on   
