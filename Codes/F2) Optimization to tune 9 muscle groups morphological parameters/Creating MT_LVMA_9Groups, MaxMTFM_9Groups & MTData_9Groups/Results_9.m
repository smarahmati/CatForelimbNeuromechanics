...
% Lmt3   
  line([XP2_time(ii,1) XP3_time(ii,1)],[YP2_time(ii,1) YP3_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on
...
% Lmt5   
  line([XP4_time(ii,1) XI_time(ii,1)],[YP4_time(ii,1) YI_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on  
  
  
elseif (theta1_time(ii,1)<0 && theta2_time(ii,1)>=0) %-----------------------------------------------
% Lmt1    
  line([XO_time(ii,1) XP4_time(ii,1)],[YO_time(ii,1) YP4_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on  
...
% Lmt3    
  line([XP5_time(ii,1) XI_time(ii,1)],[YP5_time(ii,1) YI_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on 
...
% Lmt3    
  line([XP3_time(ii,1) XI_time(ii,1)],[YP3_time(ii,1) YI_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on 
