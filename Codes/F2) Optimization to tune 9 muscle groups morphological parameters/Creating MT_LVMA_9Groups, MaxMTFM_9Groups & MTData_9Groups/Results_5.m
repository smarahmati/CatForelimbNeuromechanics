...
% Lmt1    
  line([XO_time(ii,1) XP1OW_time(ii,1)],[YO_time(ii,1) YP1OW_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on
...
% Lmt3   
  line([XP2OW_time(ii,1) XW_time(ii,1)],[YP2OW_time(ii,1) YW_time(ii,1)],'color',[1 0 0],'LineWidth',1.5);
  hold on  
