...
% Lmt1    
  line([XO_time(i,1) XP1OW_time(i,1)],[YO_time(i,1) YP1OW_time(i,1)],'color',MC,'LineWidth',4);
  hold on
...
% Lmt3   
  line([XP2OW_time(i,1) XW_time(i,1)],[YP2OW_time(i,1) YW_time(i,1)],'color',MC,'LineWidth',4);
  hold on  
...
% Lmt1    
  line([XO_time(ii,1) XP1OW_time(ii,1)],[YO_time(ii,1) YP1OW_time(ii,1)],'color',MC,'LineWidth',3);
  hold on
...
% Lmt3   
  line([XP2OW_time(ii,1) XW_time(ii,1)],[YP2OW_time(ii,1) YW_time(ii,1)],'color',MC,'LineWidth',3);
  hold on  
