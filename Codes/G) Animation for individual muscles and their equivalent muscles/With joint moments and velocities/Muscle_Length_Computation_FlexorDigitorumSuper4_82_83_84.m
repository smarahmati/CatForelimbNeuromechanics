...
cmn = 24;              % considered muscle number 
...
% Flexor Digitorum Superficialis 4(82->83) --------------------------------------------------------------------
MN = 53;
alpha1OW = WRTa;
...
% Flexor Digitorum Superficialis 4(83->84)  --------------------------------------------------------------------
MN = 54;
y1WI = q4;
XC1WI = WRT(:,1);
YC1WI = WRT(:,2);
...
%% Write information
mn = 'Flexor Digitorum Superficialis 4';                        % muscle name
...
txt_title = 'Flexor Digitorum Superficialis 4';
% title(txt_title)
% hold off
