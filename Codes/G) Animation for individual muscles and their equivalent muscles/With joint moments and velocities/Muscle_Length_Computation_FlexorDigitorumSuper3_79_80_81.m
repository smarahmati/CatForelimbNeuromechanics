...
cmn = 23;              % considered muscle number 
...
% Flexor Digitorum Superficialis 3(79->80) --------------------------------------------------------------------
MN = 51;
alpha1OW = WRTa;
...
% Flexor Digitorum Superficialis 3(80->81)  --------------------------------------------------------------------
MN = 52;
y1WI = q4;
XC1WI = WRT(:,1);
YC1WI = WRT(:,2);
...
%% Write information
mn = 'Flexor Digitorum Superficialis 3';                        % muscle name
...
% Joint Centers
% s1 = scatter(LSCP(ii,1),LSCP(ii,2),'MarkerFaceColor',[0.5, 0.5, 0],'MarkerEdgeColor',[0.5, 0.5, 0]);
% hold on
% alpha(s1,.7)

s2 = scatter(LSHL(ii,1),LSHL(ii,2),'MarkerFaceColor',[1, 0, 0],'MarkerEdgeColor',[1, 0, 0]);
hold on
alpha(s2,.7)

s3 = scatter(LELB(ii,1),LELB(ii,2),'MarkerFaceColor',[0, 1, 0],'MarkerEdgeColor',[0, 1, 0]);
hold on
alpha(s3,.7)

s4 = scatter(LWRT(ii,1),LWRT(ii,2),'MarkerFaceColor',[0, 0, 1],'MarkerEdgeColor',[0, 0, 1]);
hold on
alpha(s4,.7)

% s5 = scatter(LMCP(ii,1),LMCP(ii,2),'MarkerFaceColor',[0.5, 0, 0.5],'MarkerEdgeColor',[0.5, 0, 0.5]);
% hold on
% alpha(s5,.7)
% 
% s6 = scatter(LFT(ii,1),LFT(ii,2),'MarkerFaceColor',[0, 0.5, 0.5],'MarkerEdgeColor',[0, 0.5, 0.5]);
% hold on
% alpha(s6,.7)
...
txt_title = 'Flexor Digitorum Superficialis 3';
% title(txt_title)
% hold off
