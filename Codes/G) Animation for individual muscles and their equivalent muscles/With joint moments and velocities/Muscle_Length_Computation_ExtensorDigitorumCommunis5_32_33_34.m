...
cmn = 11;              % considered muscle number 
...
% Extensor Digitorum Communis 5(30->31) --------------------------------------------------------------------
MN = 20;
alpha1OW = ELBa;
...
% Extensor Digitorum Communis 5(31->32)  --------------------------------------------------------------------
MN = 21;
alpha1WI = WRTa;
...
%% Write information
mn = 'Extensor Digitorum Communis 5';                           % muscle name
...
txt_title = 'Extensor Digitorum Communis 5';
% title(txt_title)
% hold off
