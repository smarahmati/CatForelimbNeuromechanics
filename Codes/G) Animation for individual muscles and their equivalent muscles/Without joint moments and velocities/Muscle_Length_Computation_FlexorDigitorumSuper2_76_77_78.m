...
cmn = 22;              % considered muscle number 
...
% Flexor Digitorum Superficialis 2(76->77) --------------------------------------------------------------------
MN = 49;
alpha1OW = WRTa;
...
% Flexor Digitorum Superficialis 2(77->78)  --------------------------------------------------------------------
MN = 50;
y1WI = q4;
XC1WI = WRT(:,1);
YC1WI = WRT(:,2);
...
%% Write information
mn = 'Flexor Digitorum Superficialis 2';                        % muscle name
...
txt_title = 'Flexor Digitorum Superficialis 2';
% title(txt_title)
% hold off
